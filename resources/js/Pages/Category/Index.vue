...
watch(
  () => categoriesUrl.value,
  (updatedCategoriesUrl) => {
    router.visit(updatedCategoriesUrl, {
      preserveScroll: true,
      preserveState: true,
      replace: true,
    });
      ...
      <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div class="grid grid-cols-3 border-t border-stroke py-4.5 px-4 
          ...
          <div class="col-span-2 flex items-center">
            <p class="font-medium">Nombre de la categoría</p>
          </div>
        ...
        <!-- Table Rows -->
        <div v-for="category in categories.data" :key="category.id" class="grid grid-cols-3 border-t border-stroke 
