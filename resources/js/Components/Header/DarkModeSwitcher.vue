...
const checkTimeForDarkMode = () => {
  ...
  if (darkModeStore.darkMode !== isDark) {
    darkModeStore.darkMode = isDark
  }
}
...
onMounted(() => {
  ...
  document.documentElement.classList.toggle('dark', darkModeStore.darkMode)
...
watch(() => darkModeStore.darkMode, (isDark) => {
